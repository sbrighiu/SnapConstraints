...
public extension UIView {
    ...
    var snapsFromSuperview: [SnapConstraint] {
        get {
    ...
    @discardableResult func snaps(ofType type: SnapConstraintType) -> [SnapConstraint] {
        return snaps.filter { 
            if $0.type == type {
                return true
            } 
    ...
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(withTag tag: String) -> [SnapConstraint] {
        return snaps.filter {  
            if $0.tag == tag {
                return true
            } 
    ...
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(fromView firstView: UIView) -> [SnapConstraint] {
        return snaps.filter {  
    ...
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(ofType type: SnapConstraintType, andTag tag: String) -> [SnapConstraint] {
    ...
    /// - Parameter firstView: The view you created the constraints on.
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(fromView firstView: UIView, andTag tag: String) -> [SnapConstraint] {
        return snaps(withTag: tag).filter {  
            if $0.firstView == firstView {
                return true
            } 
    ...
    /// - Parameter firstView: The view you created the constraints on.
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(fromView firstView: UIView, andType type: SnapConstraintType) -> [SnapConstraint] {
    ...
    /// - Parameter firstView: The view you created the constraints on.
    /// - Returns: The filtered array of SnapConstraint objects.
    @discardableResult func snaps(fromView firstView: UIView, type: SnapConstraintType, andTag tag: String) -> [SnapConstraint] {
        return snaps(withTag: tag).filter {  
            if $0.type == type {
                if $0.firstView == firstView {
                    return true
